...
@bp.route("/system-principle")
def system_principle():
    return render_template("system_principle.html")


@bp.route("/accident-cases")
def accident_cases():
    return render_template("accident_cases.html")


@bp.route("/fire-analytics")
def fire_analytics():
    return render_template("fire_analytics.html")
